...
<head>
    ...
    <link href="main_assets/css/bootstrap.min.css?ver=1.2.0" rel="stylesheet">
    <link href="main_assets/css/font-awesome/css/all.min.css?ver=1.2.0" rel="stylesheet">
    <link href="main_assets/css/main.css?ver=1.2.0" rel="stylesheet">
</head>
...
<body id="top">
    <div class="site-wrapper">
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <img src="Candi-AI-Logo-Final-02.png" alt="logo" style="height: 100px; margin-bottom: 40px" />
                ...
                <div class="footer-left footer" style="margin-top: 150px; margin-bottom: -81px;">
                    <p>
        ...
        <script src="main_assets/scripts/jquery.slim.min.js?ver=1.2.0"></script>
        <script src="main_assets/scripts/bootstrap.bundle.min.js?ver=1.2.0"></script>
        <script src="main_assets/scripts/main.js?ver=1.2.0"></script>
</body>
